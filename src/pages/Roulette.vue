<template>
  <q-page class="column bg-white">
    <section class="section justify-center text-center">
      <div class="container" id="app">
        <div class="col">
          <div class="col">
            <div class="text-primary q-mt-sm" style="font-size: 35px">
              Roleta de Prêmios! <br/>
              <input type="button" class="button q-mt-md" value="Rodar Roleta" id='spin' v-on:click="spin" style="border-radius: 10px; color: white; background: #1976d2;padding: 10px"/>
              <div style="width: 18%;margin-left:42%">
                <q-input v-model="new_option"
                         v-on:keyup.enter="addOptions"
                         class="col q-mt-xl q-pa-sm" filled square
                         bg-color="white" label="Novo item" dense>
            ...
            <div class="q-ml-xl flex content-stretch" style="position: relative;width: 100%;">
              <canvas id="canvas" width="500" height="500" style="margin-left: -20px; margin-top: -325px;"></canvas>
            </div>
          </div>
          </div>
        </div>
